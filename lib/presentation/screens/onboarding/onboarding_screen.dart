...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPermissionItem(Icons.favorite, '건강 데이터', '걸음수를 자동으로 측정합니다'),
          _buildPermissionItem(Icons.ads_click, '광고', '광고를 보고 추가 복권을 받으세요'),
        ],
      ),
    );
  }
  ...
  Future<void> _completeOnboarding() async {
    try {
      ...
      await ref.read(supabaseAuthProvider.notifier).completeOnboarding('사용자');
